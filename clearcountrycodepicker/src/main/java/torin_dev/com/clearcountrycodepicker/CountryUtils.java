...
public class CountryUtils {
   ...
   */
  public static Country getByNumber(Context context, List<Country> preferredCountries, String fullNumber) {
    int firstDigit;
   ...
   */
  public static Country getByCode(Context context, List<Country> preferredCountries, int code) {
   ...
   */
  public static Country getByCode(Context context, List<Country> preferredCountries, String code) {
   ...
   * or returns null if no country matches given code.
   */
  public static Country getByNameCodeFromCustomCountries(Context context,
